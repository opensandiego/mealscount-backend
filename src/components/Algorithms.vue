<template>
    <section class="container my-3">
        ...
        <h2>GreedyLP</h2>
        <a href="https://github.com/opensandiego/mealscount-backend/blob/validate/strategies/linear_solver.py" target="_blank">(source)</a>
        <p>The GreedyLP algorithm is a metaheuristic that employs the use of mathematical programming inside of a greedy algorithm that maximizes each district's total CEP reimbursements. Specifically, the algorithm solves a single <a href="https://developers.google.com/optimization/bin/knapsack" target="_blank">knapsack problem</a> at each iteration by selecting a subset of schools that optimize the group's CEP reimbursement while respecting minimum and maximum group ISP constraints. The algorithm works best with larger school districts (i.e., schools > 25) and currently only supports optimizating CEP reimbursement. This algorithm was developed by <a href="https://www2.deloitte.com/us/en.html" target="_blank">Deloitte Consulting LLP</a> in partnership with <a href="https://www.nokidhungry.org/">No Kid Hungry</a>.</p>
